...
/* 
	Changed by LieberLieber at 11.09.2013 
	search highlighting changed
*/
	...
	$.jstree.plugin("search", {
		...
		_fn : {
			search : function (str, skip_async) {
				...
				$("ul").find('li').find('a').addClass("jstree-not-found");
				this.data.search.result.removeClass("jstree-not-found");
			...
			clear_search : function (str) {
				$("ul").find('li').find('a').removeClass("jstree-not-found");
